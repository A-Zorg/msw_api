...
result_users = pandas.read_csv('/home/alex_zatushevkiy/msw_api/users.csv')
...
for index, user in result_users.iterrows():
    try:
        ...
        result_bills = pandas.read_csv('/home/alex_zatushevkiy/msw_api/user_bills.csv')
        ...
        result_main_users = pandas.read_csv('/home/alex_zatushevkiy/msw_api/main_users.csv')
...
result_accounts = pandas.read_csv('/home/alex_zatushevkiy/msw_api/accounts.csv')
for index, account in result_accounts.iterrows():
    user = CustomUser.objects.get(hr_id=account['user_hr_id'])
    try:
        summery_by_date = ''
        with open('/home/alex_zatushevkiy/msw_api/prop.xlsx', 'rb') as file:
...
result_userdata = pandas.read_csv('/home/alex_zatushevkiy/msw_api/userdata.csv')
...
with open('/home/alex_zatushevkiy/msw_api/manager_id.txt', 'r') as file:
