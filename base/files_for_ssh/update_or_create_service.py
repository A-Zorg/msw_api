...
try:
    ...
    service_object.effective_datetime = datetime.datetime.fromtimestamp(1621071494.765802)
    service_object.save()
except:
    service_object = Service.objects.create(
        ...
        service_type='fee',
        amount=-0.2,
        effective_datetime=datetime.datetime.fromtimestamp(1621071494.765802)
    )
    service_object.save()
