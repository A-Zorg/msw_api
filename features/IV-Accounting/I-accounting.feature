...
##
    ...
    Scenario: Report result
      Given create UserPropaccounts models of user 90000 for 15 day of prev month
            | month_adj_net | month_unreal | month_gross | daily_adj_net | daily_unreal | daily_gross |
            |  -300.456     |  200         |  15.45      |   34    |  73    |  -15  |
            |  200.56     |  -134         |  89      |   78    |  -12    |  -8.42  |
      When get actual result from api of user 90000 for 15 day of prev month
      Then [Report with fields] compare expected and actual result

    Scenario: xlsx transactions MSW-727
        Given get transactions of all users by FIN
         And download xlsx file with transactions
        Then compare xlsx transactions: actual with expected
